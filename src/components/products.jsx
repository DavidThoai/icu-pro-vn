...
const families = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        video: c368Video,
        seo: 'ICU C368 dung dịch vệ sinh đa năng cho dàn lạnh, dàn nóng điều hòa và lồng máy giặt. Diệt khuẩn, không acid, không ăn mòn. Đánh bay cặn canxi, khử mùi nấm mốc.',
        claims: ['Dàn lạnh · dàn nóng · máy giặt', 'Diệt khuẩn · không acid'],
        use: 'Dàn lạnh/nóng: pha 1:1 đến 1:6. Lồng máy giặt: đổ 100–200 ml mỗi chu kỳ. Để 5–10 phút rồi xả sạch.',
        formula: 'Dung dịch gốc kiềm cao, không acid, an toàn cho nhôm và đồng. Diệt khuẩn.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        video: fs03Video,
        seo: 'Furryshine Enzyme khử mùi nước tiểu, phân chó mèo tận gốc bằng enzyme tự nhiên. Diệt khuẩn, an toàn tuyệt đối cho thú cưng và gia đình. Dùng cho nền nhà, chuồng nuôi, khay vệ sinh, nệm thú cưng. Hương bạc hà tự nhiên, thân thiện môi trường.',
