...
const tabs = [
  ...
  },
  {
    ...
    specs: [
      ...
      {
        name: 'SIÊU ÂM 1L — Dung dịch siêu âm (1 lít)',
        who: 'SIÊU ÂM 1L',
        desc: 'Dung dịch siêu âm chuyên dụng chai 1 lít cho máy rửa siêu âm trang sức. Làm sạch sâu vàng, bạc, đá quý, kim cương. Không gây hao mòn, an toàn cho da tay và đá tự nhiên. Tiết kiệm chi phí, hiệu quả tối đa.',
        ph: 'pH 7.5–8.5',
        temp: 'Chạy máy 15–90 giây mỗi mẻ, rửa lại nước sạch',
        ingredients: 'Chất hoạt động bề mặt phi ion, chất tạo phức nhẹ, nước tinh khiết. Gốc nước, không dung môi, không acid.',
      },
      {
        name: 'C819 1L — Vệ sinh bạc ố đen (1 Lít)',
        who: 'C819 1L',
        desc: 'Dung dịch vệ sinh trang sức bạc ố đen chai 1 lít. Ngâm 15–20 giây, bạc sáng lại tức thì, dùng được nhiều lần. Loại bỏ lớp ố đen (sulfide bạc) mà không mài mòn bề mặt.',
        ph: 'pH 8.0–9.0',
        temp: 'Ngâm 15–20 giây, rửa nước sạch, lau khô',
        ingredients: 'Chất làm sạch anion, chất hoạt động bề mặt, hương liệu, nước tinh khiết.',
      },
      {
        name: 'C819 5L — Vệ sinh bạc ố đen (5 Lít)',
        who: 'C819 5L',
        desc: 'Dung dịch vệ sinh trang sức bạc ố đen can 5 lít. Ngâm 15–20 giây, bạc sáng lại tức thì, dùng được nhiều lần. Tiết kiệm chi phí cho tiệm vàng.',
        ph: 'pH 8.0–9.0',
        temp: 'Ngâm 15–20 giây, rửa nước sạch, lau khô',
        ingredients: 'Chất làm sạch anion, chất hoạt động bề mặt, hương liệu, nước tinh khiết.',
      },
